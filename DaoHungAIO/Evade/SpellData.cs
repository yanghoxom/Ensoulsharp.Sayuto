        ...
        public int Radius
        {
            get
            {
                return !AddHitbox
                    ...
                    : EvadeManager.SkillShotsExtraRadius + _radius + (int)GameObjects.AllyHeroes.FirstOrDefault(x => x.Distance(ObjectManager.Player) < DaoHungAIO.Common.Champion.E.Range).BoundingRadius;
            }
            set { _radius = value; }
        }
