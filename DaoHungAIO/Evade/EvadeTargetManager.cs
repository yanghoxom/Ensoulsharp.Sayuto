                    ...
                    if (aaa == ally)
                    {
                            ...
                            ObjectManager.Player.CharacterName == "Karma")
                        {
                            if (DaoHungAIO.Evade.EvadeTargetManager.Menu["whitelist"][
                                ...
                                aaa.Distance(ObjectManager.Player) < DaoHungAIO.Common.Champion.E.Range)
                            {
                                DaoHungAIO.Common.Champion.E.CastOnUnit(aaa);
                            }
                        }
                        if (ObjectManager.Player.CharacterName == "Lux" || ObjectManager.Player.CharacterName == "Sona" ||
                            ObjectManager.Player.CharacterName == "Taric")

                        {
                            if (DaoHungAIO.Evade.EvadeTargetManager.Menu["whitelist"][
                                        ally.CharacterName.ToLower()] &&
                                aaa.Distance(ObjectManager.Player) < DaoHungAIO.Common.Champion.W.Range)
                            {
                                DaoHungAIO.Common.Champion.W.CastOnUnit(aaa);
                            }
                        }
                    }
