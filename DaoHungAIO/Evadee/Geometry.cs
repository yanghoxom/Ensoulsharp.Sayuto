...
using EnsoulSharp;
using SharpDX;
using IntPoint = EnsoulSharp.SDK.IntPoint;
    ...
    public static class Geometry
    {
        ...
        public class Polygon
        {
            ...
            public void Draw(Color color, int width = 1)
            {
                for (var i = 0; i <= Points.Count - 1; i++)
                {
                    ...
                    Drawing.DrawLine(Points[i], Points[nextIndex], width, color);
                }
            }
        }
        ...
        public class Arc
        {
            ...
            public Polygon ToPolygon(int offset = 0)
            {
                ...
                var innerCenters = Start.CircleCircleIntersection(End, innerRadius, innerRadius);
                var outerCenters = Start.CircleCircleIntersection(End, outerRadius, outerRadius);
